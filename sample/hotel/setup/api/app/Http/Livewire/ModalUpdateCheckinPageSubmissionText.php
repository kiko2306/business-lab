...
class ModalUpdateCheckinPageSubmissionText extends ModalComponent
{
    public $text;
    public $lang_id;
    ...
    {
        return view('livewire.modal-update-checkin-page-submission-text');
    }
    ...
    public function save()
    {
        ...
        $tr = Translation::where('key', TranslationKeysEnum::CHECKIN_PAGE_SUBMISSION_TEXT)
