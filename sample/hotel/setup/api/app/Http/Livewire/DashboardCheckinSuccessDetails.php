...
class DashboardCheckinSuccessDetails extends Component
{
    public $filter;
    ...
    public $checkin_success;
    public $checkin_success_filtered;
    ...
    {
        $this->checkin_success = Reservation::where('checkin_success', true)
            ->where('number', '>', 0)
            ->get();
    ...
    {
        return view('livewire.dashboard-checkin-success-details');
    }
    ...
    public function updatedFilter()
    {
        ...
        $this->checkin_success_filtered = $this->checkin_success->filter(function ($item) use ($start_date, $end_date) {
