...
class ModalUpdatePromoEmailText extends ModalComponent
{
    public $text;
    public $lang_id;
    ...
    {
        return view('livewire.modal-update-promo-email-text');
    }
    ...
    public function save()
    {
        ...
        $tr = Translation::where('key', TranslationKeysEnum::PROMO_MAIL_TEXT)
