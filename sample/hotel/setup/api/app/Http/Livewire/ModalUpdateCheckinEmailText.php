...
class ModalUpdateCheckinEmailText extends ModalComponent
{
    public $text;
    public $lang_id;
    ...
    {
        return view('livewire.modal-update-checkin-email-text');
    }
    ...
    public function save()
    {
        ...
        $tr = Translation::where('key', TranslationKeysEnum::CHECKIN_EMAIL_TEXT)
