...
class ModalUpdateBirthdayEmailText extends ModalComponent
{
    public $text;
    public $lang_id;
    ...
    {
        return view('livewire.modal-update-birthday-email-text');
    }
    ...
    public function save()
    {
        ...
        $tr = Translation::where('key', TranslationKeysEnum::BIRTHDAY_MAIL_TEXT)
