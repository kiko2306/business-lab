...
class FrmConfigTranslationCheckin extends Component
{
    ...
    {
        return view('livewire.frm-config-translation-checkin');
    }
    ...
    public function setSelectedTranslationKey(string $selected_translation_key)
    {
        switch ($selected_translation_key) {
            case TranslationKeysEnum::CHECKIN_MAIL_SUBJECT:
                $this->selected_modal = 'modal-update-checkin-email-subject';
                break;

            case TranslationKeysEnum::CHECKIN_EMAIL_TEXT:
                $this->selected_modal = 'modal-update-checkin-email-text';
                break;

            case TranslationKeysEnum::BTN_CHECKIN:
                $this->selected_modal = 'modal-update-checkin-btn-text';
                break;

            case TranslationKeysEnum::CHECKIN_PAGE_TEXT:
                $this->selected_modal = 'modal-update-checkin-page-text';
                break;

            case TranslationKeysEnum::CHECKIN_PAGE_SUBMISSION_TEXT:
                $this->selected_modal = 'modal-update-checkin-page-submission-text';
                break;
