    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th scope="col" class="text-center">Checkin Efetuado</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($checkin_sent_filtered as $cki)
            <tr>
