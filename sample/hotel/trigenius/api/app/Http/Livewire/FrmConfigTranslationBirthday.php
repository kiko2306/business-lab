...
class FrmConfigTranslationBirthday extends Component
{
    ...
    {
        return view('livewire.frm-config-translation-birthday');
    }
    ...
    public function setSelectedTranslationKey(string $selected_translation_key)
    {
        switch ($selected_translation_key) {
            case TranslationKeysEnum::BIRTHDAY_MAIL_SUBJECT:
                $this->selected_modal = 'modal-update-birthday-email-subject';
                break;

            case TranslationKeysEnum::BIRTHDAY_MAIL_TEXT:
                $this->selected_modal = 'modal-update-birthday-email-text';
                break;
