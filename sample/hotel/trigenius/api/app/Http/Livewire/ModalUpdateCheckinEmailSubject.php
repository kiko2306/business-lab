...
class ModalUpdateCheckinEmailSubject extends ModalComponent
{
    public $text;
    public $lang_id;
    ...
    {
        return view('livewire.modal-update-checkin-email-subject');
    }
    ...
    public function save()
    {
        ...
        $tr = Translation::where('key', TranslationKeysEnum::CHECKIN_MAIL_SUBJECT)
