...
class ModalUpdateQuizPageSubmissionText extends ModalComponent
{
    public $text;
    public $lang_id;
    ...
    {
        return view('livewire.modal-update-quiz-page-submission-text');
    }
    ...
    public function save()
    {
        ...
        $tr = Translation::where('key', TranslationKeysEnum::QUIZ_PAGE_SUBMISSION_TEXT)
