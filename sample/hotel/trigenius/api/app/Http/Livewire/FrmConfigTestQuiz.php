...
class FrmConfigTestQuiz extends Component
{
    public $units;
    public $countries;
    ...
    public function mount()
    {
        ...
        $this->selected_checkin_date = Carbon::now()->subDay(10)->format('Y-m-d');
        $this->selected_checkout_date = Carbon::now()->format('Y-m-d');
    ...
    {
        return view('livewire.frm-config-test-quiz');
    }
