...
class DashboardQuizSentDetails extends Component
{
    public $filter;
    ...
    {
        $this->quiz_sent = Reservation::where('quiz_sent', true)
            ->where('number', '>', 0)
            ->get();
    ...
    {
        return view('livewire.dashboard-quiz-sent-details');
    }
    ...
    public function updatedFilter()
    {
        ...
        switch ($this->filter) {
            ...
            case 'last_year':
                ...
                break;
            case 'all':
                $start_date = Carbon::now()->subYear(500);
                break;
            default:
                // code...
                break;
        ...
        $this->quiz_sent_filtered = $this->quiz_sent->filter(function ($item) use ($start_date, $end_date) {
