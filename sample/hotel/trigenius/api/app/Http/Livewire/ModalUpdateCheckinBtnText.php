...
class ModalUpdateCheckinBtnText extends ModalComponent
{
    public $text;
    public $lang_id;
    ...
    {
        return view('livewire.modal-update-checkin-btn-text');
    }
    ...
    public function save()
    {
        ...
        $tr = Translation::where('key', TranslationKeysEnum::BTN_CHECKIN)
