...
- App: http://localhost:1100
- phpMyAdmin: http://localhost:1101
- Mailpit UI: http://localhost:1102
...
DESIRED_INGRESS=$(jq -n \
  ...
  '[
    {"hostname": $app, "service": "http://localhost:1100"},
    {"hostname": $pma, "service": "http://localhost:1101"},
    {"hostname": $mail, "service": "http://localhost:1102"}
  ]')
