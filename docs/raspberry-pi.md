...
|---|---|---|---|
| authelia, dozzle, ntfy, crowdsec, netbird-vpn, nocodb, pihole, tailscale, uptime-kuma, vaultwarden, vikunja | yes | yes | |
| code-server, grocy, speedtest (`linuxserver/*`) | yes | **no** | arm64-only images |
