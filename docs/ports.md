...
`10100` authelia · `10130` code-server ·
...
`10430` guacamole · `10450` clamav (clamd, no UI) ·
...
`10590` webdav · `10600` hotel (admin UI, the app's primary hostname) · `10601` hotel-checkin (public secondary, plan.md §641) · `10602` hotel-pulse (public secondary, plan.md §644) · `10603` hotel-core (its own gated hostname, reached by the property agent; bundled `hotel-db` publishes none) · `10610` tally (bundled `tally-db` publishes none) · `10620` outline (bundled `outline-db`/`outline-redis` publish none)
...
`10150` (duplicati), `10170` (grocy) and `10330`/`10331` (portainer) are retired, not free. A removed app can still have an NPM proxy
