...
`10590` webdav · `10600` hotel (admin UI, the app's primary hostname) · `10601` hotel-checkin (public secondary, plan.md §641) · `10603` hotel-core (its own gated hostname, reached by the property agent; bundled `hotel-db` publishes none; `10602` reserved for pulse) · `10610` tally (bundled `tally-db` publishes none)
