...
export const SERVICES: Record<string, ServiceDefinition> = {
  ...
  'outline': {
    ...
    // can't do anything useful without Authelia up.
    dependsOn: ['authelia'],
    ...
    // `invalid_client`, switch to client_secret_basic as Mealie/Vikunja needed (§274/§279).
  ...
  'speedtest': {
    ...
    // The bare root only shows the public results page; the tile should land on
    // the admin sign-in.
    webPath: '/admin/login',
  },
  'tailscale': {
